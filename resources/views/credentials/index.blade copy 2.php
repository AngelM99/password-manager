                ...
                <div class="space-y-12">
                    ...
                    <div class="border-b border-white/10 pb-12">
                        <div>
                            ...
                            <p class="mt-1 text-sm/6 text-gray-400">This information will be displayed publicly so be
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center gap-x-3">
                                    <svg viewBox="0 0 24 24" fill="currentColor" class="size-12 text-gray-500">
                                        <path
                            ...
                            <!-- Cover Photo -->
                            <div>
                                <label for="cover-photo" class="block text-sm/6 font-medium text-white">Cover
                                    photo</label>
                                <div
                    ...
                    <div class="border-b border-white/10 pb-12">
                        <div>
                            ...
                            <p class="mt-1 text-sm/6 text-gray-400">Use a permanent address where you can receive mail.
                            </p>
                        </div>
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <!-- Street Address -->
                            <div class="md:col-span-2">
                                <label for="street-address" class="block text-sm/6 font-medium text-white">Street
                                    address</label>
                                <div class="mt-2">
                            ...
                            <!-- State -->
                            <div>
                                <label for="region" class="block text-sm/6 font-medium text-white">State /
                                    Province</label>
                                <div class="mt-2">
                            ...
                            <!-- ZIP Code -->
                            <div>
                                <label for="postal-code" class="block text-sm/6 font-medium text-white">ZIP / Postal
                                    code</label>
                                <div class="mt-2">
                    ...
                    <div class="border-b border-white/10 pb-12">
                        <div>
                            ...
                            <p class="mt-1 text-sm/6 text-gray-400">We'll always let you know about important changes,
                        ...
                        <div class="mt-10 space-y-10">
                                ...
                                <div class="mt-6 space-y-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex h-6 shrink-0 items-center">
                                            <div class="group grid size-4 grid-cols-1">
                                                <input id="comments" type="checkbox" name="comments" checked
                                                    ...
                                                    class="col-start-1 row-start-1 appearance-none rounded-sm border border-white/10 bg-white/5 checked:border-indigo-500 checked:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                        ...
                                        <div class="text-sm/6">
                                            ...
                                            <p id="comments-description" class="text-gray-400">Get notified when
                                                someone posts a comment on a posting.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <div class="text-sm/6">
                                            ...
                                            <p id="candidates-description" class="text-gray-400">Get notified when a
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <div class="text-sm/6">
                                            ...
                                            <p id="offers-description" class="text-gray-400">Get notified when a
                            ...
                            <fieldset>
                                ...
                                <p class="mt-1 text-sm/6 text-gray-400">These are delivered via SMS to your mobile
                                    phone.</p>
                                <div class="mt-6 space-y-6">
                                    <!-- Everything Radio -->
                                    <div class="flex items-center gap-x-3">
                                        ...
                                        <label for="push-everything"
                                            class="block text-sm/6 font-medium text-white">Everything</label>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-x-3">
                                        <input id="push-email" type="radio" name="push-notifications"
                                            class="relative size-4 appearance-none rounded-full border border-white/10 bg-white/5 before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-500 checked:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                        <label for="push-email" class="block text-sm/6 font-medium text-white">Same as
                                            email</label>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-x-3">
                                        <input id="push-nothing" type="radio" name="push-notifications"
                                            class="relative size-4 appearance-none rounded-full border border-white/10 bg-white/5 before:absolute before:inset-1 before:rounded-full before:bg-white not-checked:before:hidden checked:border-indigo-500 checked:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                        <label for="push-nothing" class="block text-sm/6 font-medium text-white">No
